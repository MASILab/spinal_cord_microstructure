...
def main():
    ...
    save_data_path = r'/nfs/masi/nathv/spinal_cord_data_2020/results_norm/intra_extra_rest_intra_greater'
    ...
    for cyn_key, cyn_val in cylinder_dict.items():
        for gsn_key, gsn_val in gaussian_dict.items():
            ...
            # File name
            model_file_name = cyn_key + '_' + gsn_key + '_intra_greater' + '.json'
            signal_file_name = cyn_key + '_' + gsn_key + '_intra_greater' + '_signal.txt'
    ...
    for cyn_key, cyn_val in cylinder_dict.items():
        for gsn_key, gsn_val in gaussian_dict.items():
            for sph_key, sph_val in sphere_dict.items():
                ...
                model_file_name = cyn_key + '_' + gsn_key + '_' + sph_key + '_intra_greater' + '.json'
                signal_file_name = cyn_key + '_' + gsn_key + '_' + sph_key + '_intra_greater' + '_signal.txt'
